...
name: tailwindcss
description: "Repository-specific guidance for Tailwind CSS v4."
applyTo: "**/*.{tsx,css}"
version: "1.0.0"
author: "johnmillerATcodemag-com"
tags: ["instructions", "tailwindcss", "cqrs"]
...
Apply these rules when editing files matching **/*.{tsx,css} in this CQRS calculator repository.
...
- Utility-first styling with accessible contrast and spacing.
