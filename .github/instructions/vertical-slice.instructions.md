...
**Related Documentation**: See [`.github/instructions/cqrs-architecture.instructions.md`](.github/instructions/cqrs-architecture.instructions.md) and [docs/developer-guide.md](docs/developer-guide.md) for the repository's current architecture baseline.
...
4. **User references CQRS together with slice-oriented cues**: `/Features`, feature folders, handlers per feature, MediatR, or an existing slice-based structure
...
- The repository already documents a different target structure and the user did not ask to change it
...
- Feature-local handlers, validators, and DTOs grouped by capability
- Existing vertical slices

**If found**: Follow the existing patterns exactly
**If not found**: Prefer the repository's existing structure. Ask user: "Should I change this repo to vertical slice architecture, or should I follow the current documented layout?"
...
- `.github/instructions/cqrs-architecture.instructions.md` - CQRS guidance and consistency rules
- `.github/instructions/ai-assisted-output.instructions.md` - AI provenance requirements
- `docs/developer-guide.md` - Repository target structure and workflow
