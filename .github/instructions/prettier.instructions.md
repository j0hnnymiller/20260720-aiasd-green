...
name: prettier
description: "Repository-specific guidance for Prettier."
applyTo: "**/*.{ts,tsx,js,jsx,css,md}"
version: "1.0.0"
author: "johnmillerATcodemag-com"
tags: ["instructions", "prettier", "cqrs"]
...
Apply these rules when editing files matching **/*.{ts,tsx,js,jsx,css,md} in this CQRS calculator repository.
...
- Consistent formatting and low-noise diffs.
