---
name: create-vitest-instructions
description: Generate an instruction file for Vitest usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-vitest-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-vitest-instructions
  title: "Generate Vitest Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/vitest.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Vitest Instructions

## Context

Create a technology-specific instruction file for Vitest that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/vitest.instructions.md with:
...
- Explain purpose, scope, and when to use Vitest in this repository.
...
Focus Notes:
- Unit tests and deterministic execution.
