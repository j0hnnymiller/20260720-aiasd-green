---
name: create-react-aria-instructions
description: Generate an instruction file for React Aria usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-react-aria-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-react-aria-instructions
  title: "Generate React Aria Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/react-aria.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate React Aria Instructions

## Context

Create a technology-specific instruction file for React Aria that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/react-aria.instructions.md with:
...
- Explain purpose, scope, and when to use React Aria in this repository.
...
Focus Notes:
- Accessible interactions and focus management.
