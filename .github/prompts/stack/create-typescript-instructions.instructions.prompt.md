---
name: create-typescript-instructions
description: Generate an instruction file for TypeScript usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-typescript-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-typescript-instructions
  title: "Generate TypeScript Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/typescript.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate TypeScript Instructions

## Context

Create a technology-specific instruction file for TypeScript that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/typescript.instructions.md with:
...
- Explain purpose, scope, and when to use TypeScript in this repository.
...
Focus Notes:
- Strict typing and CQRS-safe contracts.
