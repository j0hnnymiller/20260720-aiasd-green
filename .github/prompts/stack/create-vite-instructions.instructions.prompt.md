---
name: create-vite-instructions
description: Generate an instruction file for Vite usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-vite-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-vite-instructions
  title: "Generate Vite Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/vite.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Vite Instructions

## Context

Create a technology-specific instruction file for Vite that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/vite.instructions.md with:
...
- Explain purpose, scope, and when to use Vite in this repository.
...
Focus Notes:
- Build and dev workflow conventions.
