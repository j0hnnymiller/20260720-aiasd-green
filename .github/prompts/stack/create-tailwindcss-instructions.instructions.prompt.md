---
name: create-tailwindcss-instructions
description: Generate an instruction file for Tailwind CSS v4 usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-tailwindcss-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-tailwindcss-instructions
  title: "Generate Tailwind CSS v4 Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/tailwindcss.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Tailwind CSS v4 Instructions

## Context

Create a technology-specific instruction file for Tailwind CSS v4 that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/tailwindcss.instructions.md with:
...
- Explain purpose, scope, and when to use Tailwind CSS v4 in this repository.
...
Focus Notes:
- Utility-first styling and responsive patterns.
