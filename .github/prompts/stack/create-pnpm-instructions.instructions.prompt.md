---
name: create-pnpm-instructions
description: Generate an instruction file for pnpm usage in this CQRS calculator repository.
ai_generated: true
...
prompt_metadata:
  id: create-pnpm-instructions
  title: "Generate pnpm Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/pnpm.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate pnpm Instructions

## Context

Create a technology-specific instruction file for pnpm that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/pnpm.instructions.md with:
...
- Explain purpose, scope, and when to use pnpm in this repository.
...
Focus Notes:
- Reproducible dependency and lockfile workflows.
