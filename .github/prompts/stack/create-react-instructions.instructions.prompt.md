---
name: create-react-instructions
description: Generate an instruction file for React usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-react-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-react-instructions
  title: "Generate React Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/react.instructions.md"
...
Create a technology-specific instruction file for React that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/react.instructions.md with:
...
- Explain purpose, scope, and when to use React in this repository.
...
Focus Notes:
- UI component boundaries and hooks discipline.
