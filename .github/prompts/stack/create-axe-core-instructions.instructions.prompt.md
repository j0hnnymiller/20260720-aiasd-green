---
name: create-axe-core-instructions
description: Generate an instruction file for axe-core Playwright usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-axe-core-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-axe-core-instructions
  title: "Generate axe-core Playwright Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/axe-core.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate axe-core Playwright Instructions

## Context

Create a technology-specific instruction file for axe-core Playwright that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/axe-core.instructions.md with:
...
- Explain purpose, scope, and when to use axe-core Playwright in this repository.
...
Focus Notes:
- Automated accessibility audits in E2E.
