---
name: create-react-testing-library-instructions
description: Generate an instruction file for React Testing Library usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-react-testing-library-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-react-testing-library-instructions
  title: "Generate React Testing Library Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/react-testing-library.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate React Testing Library Instructions

## Context

Create a technology-specific instruction file for React Testing Library that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/react-testing-library.instructions.md with:
...
- Explain purpose, scope, and when to use React Testing Library in this repository.
...
Focus Notes:
- User-centric component tests and assertions.
