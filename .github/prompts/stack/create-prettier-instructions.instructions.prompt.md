---
name: create-prettier-instructions
description: Generate an instruction file for Prettier usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-prettier-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-prettier-instructions
  title: "Generate Prettier Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/prettier.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Prettier Instructions

## Context

Create a technology-specific instruction file for Prettier that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/prettier.instructions.md with:
...
- Explain purpose, scope, and when to use Prettier in this repository.
...
Focus Notes:
- Formatting consistency and low-noise diffs.
