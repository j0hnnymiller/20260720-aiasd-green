---
name: create-playwright-instructions
description: Generate an instruction file for Playwright usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-playwright-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-playwright-instructions
  title: "Generate Playwright Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/playwright.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Playwright Instructions

## Context

Create a technology-specific instruction file for Playwright that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/playwright.instructions.md with:
...
- Explain purpose, scope, and when to use Playwright in this repository.
...
Focus Notes:
- End-to-end flows mapped to acceptance criteria.
