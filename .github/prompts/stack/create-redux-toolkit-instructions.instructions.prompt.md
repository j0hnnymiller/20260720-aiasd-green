---
name: create-redux-toolkit-instructions
description: Generate an instruction file for Redux Toolkit usage in this CQRS calculator repository.
ai_generated: true
...
source: ".github/prompts/stack/create-redux-toolkit-instructions.instructions.prompt.md"
prompt_metadata:
  id: create-redux-toolkit-instructions
  title: "Generate Redux Toolkit Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/redux-toolkit.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate Redux Toolkit Instructions

## Context

Create a technology-specific instruction file for Redux Toolkit that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/redux-toolkit.instructions.md with:
...
- Explain purpose, scope, and when to use Redux Toolkit in this repository.
...
Focus Notes:
- Command handlers and state invariants.
