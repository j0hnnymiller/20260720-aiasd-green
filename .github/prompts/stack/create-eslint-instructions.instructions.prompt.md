---
name: create-eslint-instructions
description: Generate an instruction file for ESLint usage in this CQRS calculator repository.
ai_generated: true
...
prompt_metadata:
  id: create-eslint-instructions
  title: "Generate ESLint Instructions"
  owner: "johnmillerATcodemag-com"
  version: "1.0.0"
  output_path: ".github/instructions/eslint.instructions.md"
  category: documentation
  output_format: markdown
---

# Generate ESLint Instructions

## Context

Create a technology-specific instruction file for ESLint that aligns with the CQRS web calculator architecture documented in docs/developer-guide.md.
...
Generate .github/instructions/eslint.instructions.md with:
...
- Explain purpose, scope, and when to use ESLint in this repository.
